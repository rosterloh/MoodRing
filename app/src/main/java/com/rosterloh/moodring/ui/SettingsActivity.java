...
public class SettingsActivity extends ActionBarActivity {
    ...
    public static class SettingsFragment extends PreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_bt_autoconnect_key)));
            bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_bt_address_key)));
        }
