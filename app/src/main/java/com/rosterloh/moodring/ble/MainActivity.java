...
import com.rosterloh.moodring.ExtendedBluetoothDevice;
...
public class MainActivity extends AppCompatActivity implements ConfigureBleFragment.BleConfigFragmentInteractionListener,
    ...
    @Override
    public void configureBleNode() {
        mBLEService.writeLedCharacteristic();
    }
    ...
    private final ServiceConnection mBleServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if(mBLEService != null){
                if(!mBLEService.initialiseBluetooth())
                {
    ...
    private void showError(final String error, boolean setAction){
        ...
        final Snackbar snackbar = Snackbar.make(mRelativeLayout, error, Snackbar.LENGTH_LONG);
